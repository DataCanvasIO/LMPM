...
def run(params: dict = None, inputs: dict = None, outputs=None) -> PMNodeOutput:
    logger.info("Welcome to use System Message Prompt Template!")
    ...
    systemPromptTemplate = SystemMessagePromptTemplate(template_content, 'system', role_prompt, prompt_variables, model_conf, model_param_define, model_params)
    result = systemPromptTemplate.exec()
