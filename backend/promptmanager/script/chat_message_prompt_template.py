...
def run(params: dict = None, inputs: dict = None, outputs=None) -> PMNodeOutput:
    logger.info("Welcome to use Chat Message Prompt Template!")
    ...
    promptTemplate = PromptTemplate(template_content, role_name, role_prompt, prompt_variables, model_conf,
                                    model_param_define, model_params)
